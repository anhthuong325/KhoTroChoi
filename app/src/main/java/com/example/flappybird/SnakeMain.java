...
public class SnakeMain {
    ...
    public SnakeMain(Bitmap bm, int x, int y, int length) {
        this.bm = bm;
        this.x = x;
        this.y = y;
        this.length = length;
        bm_body_bottom_left = Bitmap.createBitmap(bm, 0, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_body_bottom_right = Bitmap.createBitmap(bm, SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_body_horizontal = Bitmap.createBitmap(bm, 2*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_body_top_left = Bitmap.createBitmap(bm, 3*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_body_top_right = Bitmap.createBitmap(bm, 4*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_body_vertical = Bitmap.createBitmap(bm, 5*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_head_down = Bitmap.createBitmap(bm, 6*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_head_left = Bitmap.createBitmap(bm, 7*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_head_right = Bitmap.createBitmap(bm, 8*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_head_up = Bitmap.createBitmap(bm, 9*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_tail_up = Bitmap.createBitmap(bm, 10*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_tail_right = Bitmap.createBitmap(bm, 11*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_tail_left = Bitmap.createBitmap(bm, 12*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        bm_tail_down = Bitmap.createBitmap(bm, 13*SnakeView.sizeOfMap, 0, SnakeView.sizeOfMap, SnakeView.sizeOfMap);
        arrPartSnake.add(new PartSnake(bm_head_right, x, y));
        for(int i = 1; i < length - 1; i++){
            arrPartSnake.add(new PartSnake(bm_body_horizontal, arrPartSnake.get(i - 1).getX() - SnakeView.sizeOfMap, y));
        }
        arrPartSnake.add(new PartSnake(bm_tail_right, arrPartSnake.get(length - 2).getX() - SnakeView.sizeOfMap, y));
        setMove_right(true);
    }
    ...
    public void update(){
        ...
        if(move_right){
            arrPartSnake.get(0).setX(arrPartSnake.get(0).getX() + SnakeView.sizeOfMap);
            arrPartSnake.get(0).setBm(bm_head_right);
        } else if(move_left){
            arrPartSnake.get(0).setX(arrPartSnake.get(0).getX() - SnakeView.sizeOfMap);
            arrPartSnake.get(0).setBm(bm_head_left);
        } else if(move_top){
            arrPartSnake.get(0).setY(arrPartSnake.get(0).getY() - SnakeView.sizeOfMap);
